<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Depositor.aspx.cs" Inherits="SHe_Helper.Depositor1" %>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="DepositorAccount.aspx"><i class="fa fa-money"></i><span class="nav-label">Account</span></a>
                    </li>
                    <li>
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group">
                                        <label>CIF</label>
                                        <asp:TextBox runat="server" ID="txtCif" TextMode="SingleLine" CssClass="form-control login" Enabled="false" />
                                    ...
                                    <div class="form-group">
                                        <label>Aadhar</label>
                                        <asp:TextBox runat="server" ID="txtAadhar" TextMode="SingleLine" CssClass="form-control login" Enabled="false" />

                                    </div>
                                    <div class="form-group">
                                        <label>Date of Birth</label>
                                        <asp:TextBox runat="server" ID="txtDob" TextMode="SingleLine" CssClass="form-control login" Enabled="false" />
                                    ...
                                    <div class="form-group">
                                        <label>Pan</label>
                                        <asp:TextBox runat="server" ID="txtPan" TextMode="SingleLine" CssClass="form-control login" Enabled="false" />
                                ...
                                <asp:Repeater ID="rptData2" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                            ...
                                            <td><%# Convert.ToDateTime(Eval("D_loandate")).ToString("yyyy-MM-dd")%></td>
