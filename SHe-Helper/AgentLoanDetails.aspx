<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentLoanDetails.aspx.cs" Inherits="SHe_Helper.AgentLoanDetails" %>
                                ...
                                <asp:Repeater ID="rptData" runat="server"  >
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                            ...
                                            <td><%# Eval("D_Name")%></a></td>
                                            <td><%# Eval("CIF")%></td>
                                            <td class="td-center"><a href="#" onclick="MyPopUpWin('LoanDetails.aspx?id=<%# Eval("D_accno")%>',1000,600); return false;" ><%# Eval("D_accno")%></td>
                                            <td><%# Convert.ToDateTime(Eval("D_loandate")).Date.ToString("yyyy-MM-dd")%></td>
                                            <td><%# Eval("D_loanbal")%></td>
