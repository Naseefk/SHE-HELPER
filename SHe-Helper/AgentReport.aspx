<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentReport.aspx.cs" Inherits="SHe_Helper.AgentReport" %>
...
<head>
    ...
    <title>Agent | Allowance Report</title>
                ...
                <div class=" col-sm">
                    <div class="ibox">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtDate" TextMode="Date" CssClass="form-control-sm form-control width" />
                        </div>
                        <div>
