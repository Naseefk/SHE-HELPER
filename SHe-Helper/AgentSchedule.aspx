<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentSchedule.aspx.cs" Inherits="SHe_Helper.AgentSchedule" %>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="form-group">
                                    <asp:TextBox runat="server" ID="txtScheduleNo" TextMode="Singleline" CssClass="form-control form-control-sm width" />
                                    <asp:Button runat="server" ID="btnScheduleNo" Text="Schedule No." CssClass="btn btn-primary m-t-n-xs" OnClick="btnScheduleNo_Click" />
                            </div>
