<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentCollection.aspx.cs" Inherits="SHe_Helper.AgentCollection" %>
                                ...
                                <asp:Repeater ID="rptData" runat="server"  >
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                            ...
                                            <td><a onclick="MyPopUpWin('/AgentCollectionAdvance.aspx?id=<%# Eval("D_accno")%>',1000,600); return false;"><i class="fa fa-check text-navy"></i></a></td>
                                            
                                            <asp:HiddenField runat="server" ID="hidden" Value='<%# Eval("D_accno") %>' />
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <asp:button runat="server" ID="btnSave" text="Save" OnClick="btnSave_Click" CssClass="btn btn-primary float-right m-t-n-xs"/>
                                    </FooterTemplate>
                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <asp:Repeater ID="rptData2" runat="server"  >
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                            ...
                                            <td><asp:Label runat="server" ID="lblNmber" Text='<%# Container.ItemIndex + 1 %>' /></td>
                                            <td><%# Eval("D_Name")%></td>
                                            <td><%# Eval("CIF")%></td>
                                            <td><%# Eval("D_accno")%></td>
                                            <td><%# Eval("D_denomination")%></td>
                               ...
                               <div class="form-group">
                                            ...
                                            <asp:label runat="server" ID="lblTotalAcc" CssClass="lbl1" />
                                            <label style="margin-left:20px">Total Amount: </label>
                                            <asp:label runat="server" ID="lblTotalAmt" CssClass="lbl1" />
                                        </div>
                            </div>
