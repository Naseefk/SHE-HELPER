<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="SHe_Helper.Admin" %>
                                ...
                                <asp:Repeater ID="rptData" runat="server" OnItemDataBound="rptData_ItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                            ...
                                            <td><a onclick="MyPopUpWin('/agentDetails.aspx?id=<%# Eval("Agent_id")%>',1000,600); return false;"><%# Eval("Agent_id")%></a></td>
                                            <td><%# Eval("A_name")%></td>
                                            <td><%# Eval("A_housename") + "," + Eval("A_place") + "," +Eval("A_po") + "," +Eval("A_pin")%> </td>
                                            <td><%# Eval("A_contact")%></td>
                                            <td>
                                ...
                                <asp:Repeater ID="Repeater2" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr class="gradeX">
                                             ...
                                             <td><a onclick="MyPopUpWin('/DepositorDetails.aspx?cif=<%# Eval("CIF")%>',1000,600); return false;"><%# Eval("CIF")%></a></td>
                                            <td><%# Eval("D_name")%></td>
                                            <td><%# Eval("D_housename") + "," + Eval("D_place")+ "," + Eval("D_post")+ "," + Eval("D_pin")%></td>
                                            <td><%# Eval("D_aadhar")%></td>
